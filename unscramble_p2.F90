...
!           out_template = '../unscramble/pot_'
         ...
         ! ELSEIF (filename.EQ.2) THEN
          ! in_template = '/work/kkadam/binary_hydro_sim/run1/output/data/pre'
          ! out_template = '/work/kkadam/binary_hydro_sim/run1/output/unscramble/pres_'  
           !in_template = './pre'
           !out_template = "../unscramble/pres_"
          !ELSEIF (filename.EQ.9) THEN
          ! in_template = './etot'
          ! out_template = '../unscramble/etot_'
          ELSE
!           STOP
          ENDIF
          !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
